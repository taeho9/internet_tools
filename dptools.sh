...
if [ $FNAME = "all" ]; then
    scp -i ~rocky/.ssh/blogger_id_rsa -P 4040 /home/rocky/projects/tools/* taeho@blogger.pe.kr:/home/taeho/tools/
    echo "Upload Complete..!"
    ssh -i ~rocky/.ssh/blogger_id_rsa -p 4040 taeho@blogger.pe.kr "sudo cp /home/taeho/tools/* /var/www/tools/"
    echo "Deploy Complete..!"
else
    scp -i ~rocky/.ssh/blogger_id_rsa -P 4040 /home/rocky/projects/tools/$FNAME taeho@blogger.pe.kr:/home/taeho/tools/
    echo "Upload Complete..!"
